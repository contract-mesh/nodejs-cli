...
var docInheritance = require("./doc-inheritance");
function parseProject(projectPath) {
    return __awaiter(this, void 0, void 0, function () {
        var data, project, expandResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs.readFile(projectPath, { encoding: 'utf-8' })];
                case 1:
                    data = _a.sent();
                    project = yaml.parse(data);
                    ...
                    return [4 /*yield*/, docInheritance.expand(project)];
                case 2:
